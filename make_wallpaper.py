...
def image_merge(images_dir, output_dir='output', output_name='merge.jpg', restriction_max_width=None, restriction_max_height=None, column=8, max_width=2560, max_height=1440):
...
if __name__ == '__main__':
    ...
    DIR = os.path.join("downloads", "images", "full")

    # image_merge(images_dir=DIR, column=12, max_width=2560, max_height=1440)

    image_merge(images_dir=DIR, column=10, output_name="merge.jpg", max_width=2560, max_height=2560)
